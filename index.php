    ...
    <div class="container">
      <div class="starter-template-main">
        ...
        <p><b>Sección 503</b></p>
          ...
          <p>
          	<a href="<?= SUBPATH; ?>/efectivo.php" class="btn btn-primary" style="width:300px;"> Administración del Efectivo.</a>
          </p>
          <p >
          	<a href="<?= SUBPATH; ?>/inventario.php" class="btn btn-primary" style="width:300px;"> Administración del Inventario.</a>
          </p>
          <p >
            <a href="<?= SUBPATH; ?>/cuentasxcobrar.php" class="btn btn-primary" style="width:300px;"> Administración de Cuentas por Cobrar.</a>
          </p>
